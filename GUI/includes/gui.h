...
inline void colorSettings()
{
	...
	colors[ImGuiCol_FrameBgActive] = ImVec4(0.79f, 0.33f, 0.33f, 1.00f);
	colors[ImGuiCol_TitleBg] = ImVec4(0.04f, 0.04f, 0.04f, 1.00f);
	colors[ImGuiCol_TitleBgActive] = ImVec4(0.79f, 0.33f, 0.33f, 1.00f);
	...
	colors[ImGuiCol_CheckMark] = ImVec4(0.79f, 0.33f, 0.33f, 1.00f);
	colors[ImGuiCol_SliderGrab] = ImVec4(0.79f, 0.33f, 0.33f, 1.00f);
	colors[ImGuiCol_SliderGrabActive] = ImVec4(0.92f, 0.21f, 0.21f, 1.00f);
